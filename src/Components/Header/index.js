    ...
    <div>
        ...
        <div className="add-task">
            <form onSubmit={onSubmit} className="input-form" >
                ...
                <svg className='plus-svg' fill="#F09440" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 349.03 349.031" xmlSpace="preserve"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
